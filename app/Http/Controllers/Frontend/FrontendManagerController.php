...
class FrontendManagerController extends Controller
{
    ...
    {
        $data = array();
        $aa = $this->option->getAppearanceData();
        ...
        if ($aa['home'] === 'krystal') {
            return view('frontend-templates.home.krystal.krystal', $data);
        } else {
    ...
    public function productCategoriesSinglePageContent($params)
    {
        ...
        if (count($get_cat_product_and_breadcrumb) > 0) {
            ...
            if ($aa['header'] === 'krystal') {
                return view('pages.krystal.category', $data);
            } else {
    ...
    public function productsPageContent()
    {
        ...
        if (count($get_product) > 0) {
            ...
            if ($aa['header'] === 'krystal') {
                if (isset($_GET['srch_term'])) {
                    return view('frontend-templates.product.krystal.krystal', $data);
                }
                return view('frontend-templates.product.krystal.krystal', $data);
            } else {
    ...
    public function productSinglePageContent($params)
    {
        ...
        if (!empty($get_product)) {
            ...
            if ($aa['header'] === 'krystal') {
                return view('frontend-templates.single-product.krystal.krystal', $data);
            } else {
    ...
    public function checkoutPageContent()
    {
        ...
        if ($aa['home'] === 'krystal') {
            return view('pages.krystal.checkout', $data);
        } else {
    ...
    public function cartPageContent()
    {
        ...
        if ($aa['header'] === 'krystal') {
            return view('pages.krystal.cart', $data);
        } else {
    ...
    public function blogsPageContent()
    {
        ...
        if ($aa['header'] === 'krystal') {
            return view('frontend-templates.blog.krystal.krystal', $data);
        } else {
