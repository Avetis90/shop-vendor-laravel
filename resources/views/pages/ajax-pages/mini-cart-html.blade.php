<a href="" class="main show-mini-cart" data-id="1"> <span
            class="d-none d-md-inline">{!! trans('frontend.menu_my_cart') !!}</span> <span
            class="fa fa-shopping-cart"></span> <span class="cart-count"><span
                id="total_count_by_ajax">{!! Cart::count() !!}</span></span></a>
    ...
    @if( Cart::count() >0 )
        <div id="cd-cart">
            ...
            <div class="cd-cart-total">
                <p>{!! trans('frontend.total') !!}
                    <span>{!! price_html( get_product_price_html_by_filter(Cart::getTotal()) ) !!}</span></p>
            </div>
