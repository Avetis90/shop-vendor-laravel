...
<div class="row">
  <div class="col-6">
    <h5><?php echo trans('admin.sizes_list'); ?></h5>
  </div>
  <div class="col-6">
    <div class="pull-right">
      <button data-toggle="modal" data-target="#addDynamicSizes" class="btn btn-primary custom-event-sizes btn-sm" type="button"><?php echo trans('admin.add_new_size'); ?></button>
    </div>  
  </div>
</div>
<br>
  ...
  <div class="modal-dialog add-sizes-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <p class="no-margin"><?php echo trans('admin.create_new_product_size'); ?></p>
