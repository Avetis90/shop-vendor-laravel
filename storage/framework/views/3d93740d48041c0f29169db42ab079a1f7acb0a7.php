<a href="" class="main show-mini-cart" data-id="1"> <span
            class="d-none d-md-inline"><?php echo trans('frontend.menu_my_cart'); ?></span> <span
            class="fa fa-shopping-cart"></span> <span class="cart-count"><span
                id="total_count_by_ajax"><?php echo Cart::count(); ?></span></span></a>
                ...
                <?php $__currentLoopData = Cart::items(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        ...
                        <a href="<?php echo e(route('removed-item-from-cart', $index)); ?>"
                           class="cd-item-remove cd-img-replace cart_quantity_delete"></a>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>

            <div class="cd-cart-total">
                <p><?php echo trans('frontend.total'); ?>

                    <span><?php echo price_html( get_product_price_html_by_filter(Cart::getTotal()) ); ?></span></p>
            </div>
