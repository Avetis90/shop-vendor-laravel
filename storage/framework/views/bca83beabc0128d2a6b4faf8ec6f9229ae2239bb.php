        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 blog-extra-padding">
          <div class="blog-content-elements-main">
            ...
            <div class="blog-text">
              ...
              <br>
              <div class="btn-content"><a class="btn btn-block btn-default" href="<?php echo e(route('blog-single-page', $row['post_slug'])); ?>"><?php echo trans('frontend.read_more_label'); ?></a></div>
            </div>
          </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
