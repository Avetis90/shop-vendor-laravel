...
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/jquery-2.1.4.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/bootstrap.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/jquery-ui.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/owl.carousel.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/wow.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/jquery.actual.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/chosen.jquery.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/jquery.bxslider.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/jquery.sticky.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/jquery.elevateZoom.min.js')); ?>"></script>

<script src="<?php echo e(URL::asset('krystal/js/fancybox/source/jquery.fancybox.pack.js')); ?>"></script>
<script src="<?php echo e(URL::asset('krystal/js/fancybox/source/helpers/jquery.fancybox-media.js')); ?>"></script>
<script src="<?php echo e(URL::asset('krystal/js/fancybox/source/helpers/jquery.fancybox-thumbs.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/function.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/Modernizr.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/jquery.plugin.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('krystal/js/jquery.countdown.js')); ?>"></script>