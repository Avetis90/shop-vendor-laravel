...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title"><?php echo trans('admin.update_post_page_title'); ?> &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.all_blogs')); ?>"><?php echo trans('admin.posts_list'); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" href="<?php echo e(route('admin.add_blog')); ?>"><?php echo trans('admin.add_new_post_top_title'); ?></a>&nbsp;&nbsp;<a class="btn btn-default btn-sm" target="_blank" href="<?php echo e(route('blog-single-page', $blog_details_by_slug['post_slug'])); ?>"><?php echo trans('admin.view'); ?></a></h3>
      <div class="box-tools pull-right">
        <button class="btn btn-primary btn-sm" type="submit"><?php echo trans('admin.update'); ?></button>
      </div>
    </div>
  </div>
